...
Fix delivery logistics in northeastern Brazilian states (AL, SE, MA, RJ) where return rates exceed 20%
Quality-review the top 5 worst categories, especially office_furniture which loses R$ 87,000+ to returns
Deploy the ML risk score at checkout to flag high-risk orders for human review before fulfillment
Address the November-March seasonal return spike with extra QA staffing and tighter shipping SLAs
Technical Approach
